        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 11, 1, 12, 36, 56, 202, DateTimeKind.Local).AddTicks(1624)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("139b9d0b-967b-454a-b471-b2bb5f6c7522"), "60817238-009c-444e-801a-caf3d9bf1c54", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "68549cea-9a64-4774-82e9-3db1e4c6d1bc", new DateTime(2000, 11, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "truong30112000@gmail.com", true, "Phi Truong", "Nguyen Vu", false, null, "truong30112000@gmail.com", "admin", "AQAAAAEAACcQAAAAEL9n1lO1hKWuxYo0lSvVRhpNodNEvDsLnnfz8ctHnFlYR4M21zMHVEORdU9nSHPMUA==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 11, 1, 12, 36, 56, 219, DateTimeKind.Local).AddTicks(6258), 100000m, 200000m });
